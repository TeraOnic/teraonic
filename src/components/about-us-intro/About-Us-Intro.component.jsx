...
const AboutUsIntro = () => {
  return (
    <section className="relative py-24 px-4 md:px-8 mt-12 mb-20 overflow-x-hidden">
      {/* Decorative Blob */}
        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="w-full md:w-1/3">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-7xl font-nura text-primary leading-tight">
                Building <br />
            ...
            <div className="w-full md:w-2/3">
              ...
              <p className="text-gray-600 text-base md:text-lg leading-relaxed font-light mt-6">
